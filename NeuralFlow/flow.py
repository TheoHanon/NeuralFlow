...
class Flow_v2:
    ...
    def fit(self, x, y, epochs, batch_size, memory_epochs = -1, validation_set = None, callbacks = None):
        ...
        for model in self.models:
            ...
            model.fit(x = x, y = y, batch_size = batch_size, epochs = epochs, callbacks = callbacks, validation_data = validation_set)
